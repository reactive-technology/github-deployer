var inquirer = require('inquirer'),
    ...
    prompts = [{
        ...
        type: 'input',
        name: 'prepareCmd',
        message: 'prepare deployment, clean ...',
        ...
        default: 'rm -r {repository_name} && git clone ${repository_ssh_url} && cd {repository_name}'
    },
        {
        type: 'input',
        name: 'buildCmd',
        ...
        default: 'yarn install && echo BACKEND_HOST=http://livehub.fautpastest.com > .env && yarn build'
    }, {
        type: 'input',
        name: 'installCmd',
        message: 'Shell command to be issued after fetching new version. Could be something like npm install or grunt deploy, or whatever',
